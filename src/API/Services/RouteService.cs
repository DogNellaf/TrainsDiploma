...
namespace API.Services
{
    public class RouteService: Service<Route>
    {
        ...
        {
            return $"DepartureTime = '{route.DepartureTime:yyyy-dd-MM HH:mm:ss.fff}', " +
        ...
        {
            return $"(DepartureTime, DepartureCityId, Duration, ArrivalCityId, Price) " +
                   $"VALUES ('" +
                   $"{route.DepartureTime:yyyy-dd-MM HH:mm:ss.fff}', " +
                   $"{route.DepartureCityId}, " +
                   $"{route.Duration}, " +
                   $"{route.ArrivalCityId}, " +
                   $"{route.Price})";
        }
